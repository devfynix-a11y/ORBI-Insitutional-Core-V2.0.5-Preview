# ORBI Sovereign Node: Quick Start Guide (v30.0)
**Version**: 30.0.0-stable  
...
*   **Note**: Ensure SMTP environment variables are configured.
...
*   **Alerts**: The system automatically sends email alerts to the `ADMIN_ALERT_EMAIL` and SMS alerts to `ADMIN_ALERT_PHONE` (configured in environment) when a reconciliation discrepancy is detected between internal vaults and external partners.
